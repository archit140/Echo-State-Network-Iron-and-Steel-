...
def train_esn(cfg, train_in, train_out):
    esn = ESNLayer(n_in=1, n_res=cfg['n_res'], n_out=1, spectral_radius=cfg['rho'], density=cfg['density'], input_scale=cfg['input_scale'], leak_rate=cfg['leak_rate'], reg=cfg['reg'], seed=cfg['seed'], device=cfg['device'])
